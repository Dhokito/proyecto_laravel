...
@section("contenido")
    ...
    <form action="{{route('alquilers.store')}}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="f_alquiler" name="f_alquiler" placeholder="f_alquiler" value="{{old('f_alquiler')}}">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="id_coche" name="id_coche" placeholder="id_coche" value="{{old('id_coche')}}">
        </div>
        <div class="form-group">
            <label for="id_cliente">Id_Cliente</label>
            <input type="text" class="form-control" id="id_cliente" name="id_cliente" placeholder="id_cliente" value="{{old('id_cliente')}}">
        </div>
